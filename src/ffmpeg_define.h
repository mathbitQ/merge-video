...
/*
    File: ffmpeg_define.h
    Date created: August 2024
    Author: mathbitQ
    Description: A definition for FFmpeg command to run
                 it API to support this software, includes
                 creating modified version of the current video
                 and merging the modified version to create
                 the final product (merged video).
    Version: 1.0
*/
...
#define FFMPEG_INPUT                "./bin/ffmpeg -i "
#define FFMPEG_INPUT_WINDOWS        ".\\bin\\ffmpeg -i "
