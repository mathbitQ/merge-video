...
//Command: ./bin/ffmpeg -i <path_to_file> [-b:v <amount>k|M](optional) [-maxrate <amount>k|M](optional) [-bufsize <amount>k|M](optional) [-r <amount>](optional) -c:v libx264 <output_file>
wxString setAllSettingMedia(wxString inputMedia,
                            wxString outputMedia,
                            double bitrate,
                            int bitrateType,
                            int framerate,
                            ...
                            double bufSize)
{
    wxString command;
    #ifdef WIN32
        command = FFMPEG_INPUT_WINDOWS;
    #endif //WIN32
    #ifdef linux
        command = FFMPEG_INPUT;
    #endif // linux
...
//Command: ./bin/ffmpeg -f concat -safe 0 -i <path_to_text_file> -c copy <output_file>
...
void MainFrame::BindAction()
{
    ...
    //Example
    btnExportFile->Bind(wxEVT_BUTTON, &MainFrame::OnExportClicked, this);
...
void MainFrame::OnExportClicked(wxCommandEvent &evt)
{
